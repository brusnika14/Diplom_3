...
public class RegisterPage {
    ...
    private final By  passwordErrorDisplayed = By.xpath("//p[contains(@class,'input__error') and contains(text(),'Некорректный пароль')]");
    ...
    public boolean isPasswordErrorDisplayed() {
        return !driver.findElements(passwordErrorDisplayed).isEmpty();
    }
}